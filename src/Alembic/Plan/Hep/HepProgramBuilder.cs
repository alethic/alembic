...
/// </summary>
[Provenance("org.apache.calcite.plan.hep.HepProgramBuilder")]
public sealed class HepProgramBuilder
{

    [Provenance("org.apache.calcite.plan.hep.HepProgramBuilder.instructions")]
    ...
    /// </summary>
    [Provenance("org.apache.calcite.plan.hep.HepProgramBuilder.group")]
    int _group = -1;
    ...
    /// </summary>
    [Provenance("org.apache.calcite.plan.hep.HepProgramBuilder", "addRuleClass(Class<R>)")]
    ...
    /// </summary>
    [Provenance("org.apache.calcite.plan.hep.HepProgramBuilder", "addRuleCollection(Collection<RelOptRule>)")]
    ...
    /// </summary>
    [Provenance("org.apache.calcite.plan.hep.HepProgramBuilder", "addRuleInstance(RelOptRule)")]
    ...
    /// </summary>
    [Provenance("org.apache.calcite.plan.hep.HepProgramBuilder", "addRuleByDescription(String)")]
    ...
    /// </summary>
    [Provenance("org.apache.calcite.plan.hep.HepProgramBuilder", "addGroupBegin()")]
    ...
    /// </summary>
    [Provenance("org.apache.calcite.plan.hep.HepProgramBuilder", "addGroupEnd()")]
    ...
    /// </summary>
    [Provenance("org.apache.calcite.plan.hep.HepProgramBuilder", "addConverters(boolean)")]
    ...
    /// than one parent.
    /// </summary>
    [Provenance("org.apache.calcite.plan.hep.HepProgramBuilder", "addCommonRelSubExprInstruction()")]
    ...
    /// </summary>
    [Provenance("org.apache.calcite.plan.hep.HepProgramBuilder", "addMatchOrder(HepMatchOrder)")]
    ...
    /// </summary>
    [Provenance("org.apache.calcite.plan.hep.HepProgramBuilder", "addMatchLimit(int)")]
    ...
    /// </summary>
    [Provenance("org.apache.calcite.plan.hep.HepProgramBuilder", "addSubprogram(HepProgram)")]
    ...
    [Provenance("org.apache.calcite.plan.hep.HepProgramBuilder", "addInstruction(HepInstruction)")]
    ...
    /// </summary>
    [Provenance("org.apache.calcite.plan.hep.HepProgramBuilder", "build()")]
