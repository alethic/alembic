...
/// runs it.
/// </summary>
[Provenance(ProvenanceSource.Calcite, "org.apache.calcite.plan.hep.HepInstruction")]
public abstract class HepInstruction
{
    ...
    /// </summary>
    [Provenance(ProvenanceSource.Calcite, "org.apache.calcite.plan.hep.HepInstruction", "prepare(PrepareContext)")]
    internal abstract HepState Prepare(PrepareContext px);

    /// <summary>
    /// Executes all rules of a given type.
    /// </summary>
    [Provenance(ProvenanceSource.Calcite, "org.apache.calcite.plan.hep.HepInstruction.RuleClass")]
    ...
    /// </summary>
    [Provenance(ProvenanceSource.Calcite, "org.apache.calcite.plan.hep.HepInstruction.RuleCollection")]
    ...
    /// </summary>
    [Provenance(ProvenanceSource.Calcite, "org.apache.calcite.plan.hep.HepInstruction.ConverterRules")]
    ...
    /// </summary>
    [Provenance(ProvenanceSource.Calcite, "org.apache.calcite.plan.hep.HepInstruction.RuleInstance")]
    ...
    /// </summary>
    [Provenance(ProvenanceSource.Calcite, "org.apache.calcite.plan.hep.HepInstruction.RuleLookup")]
    ...
    /// </summary>
    [Provenance(ProvenanceSource.Calcite, "org.apache.calcite.plan.hep.HepInstruction.MatchOrder")]
    ...
    /// </summary>
    [Provenance(ProvenanceSource.Calcite, "org.apache.calcite.plan.hep.HepInstruction.MatchLimit")]
    ...
    /// </summary>
    [Provenance(ProvenanceSource.Calcite, "org.apache.calcite.plan.hep.HepInstruction.SubProgram")]
    ...
    /// </summary>
    [Provenance(ProvenanceSource.Calcite, "org.apache.calcite.plan.hep.HepInstruction.BeginGroup")]
    ...
    /// </summary>
    [Provenance(ProvenanceSource.Calcite, "org.apache.calcite.plan.hep.HepInstruction.Placeholder")]
    ...
    /// </summary>
    [Provenance(ProvenanceSource.Calcite, "org.apache.calcite.plan.hep.HepInstruction.EndGroup")]
    ...
    /// </summary>
    [Provenance(ProvenanceSource.Calcite, "org.apache.calcite.plan.hep.HepInstruction.PrepareContext")]
    internal sealed class PrepareContext
    {

        [Provenance(ProvenanceSource.Calcite, "org.apache.calcite.plan.hep.HepInstruction.PrepareContext.planner")]
        internal readonly HepPlanner Planner;

        [Provenance(ProvenanceSource.Calcite, "org.apache.calcite.plan.hep.HepInstruction.PrepareContext.programState")]
