...
/// dimensions, etc.).
/// </summary>
[Provenance("org.apache.calcite.plan.RelOptCost")]
public interface ICost
{
    ...
    /// </summary>
    [Provenance("org.apache.calcite.plan.RelOptCost", "minus(RelOptCost)")]
    ICost Minus(ICost other);

    /// <summary>
    /// This cost scaled by <paramref name="factor"/>.
    /// </summary>
    [Provenance("org.apache.calcite.plan.RelOptCost", "multiplyBy(double)")]
    ...
    /// </summary>
    [Provenance("org.apache.calcite.plan.RelOptCost", "divideBy(RelOptCost)")]
    double DivideBy(ICost other);

    /// <summary>
    /// Whether this cost equals <paramref name="other"/> within a small epsilon on every component.
    /// </summary>
    [Provenance("org.apache.calcite.plan.RelOptCost", "isEqWithEpsilon(RelOptCost)")]
