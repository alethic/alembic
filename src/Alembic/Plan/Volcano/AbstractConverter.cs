...
/// </summary>
[Provenance("org.apache.calcite.plan.volcano.AbstractConverter")]
public sealed class AbstractConverter : ConverterImpl
{
    ...
    /// </summary>
    [Provenance("org.apache.calcite.plan.volcano.AbstractConverter", "AbstractConverter(RelOptCluster, RelSubset, RelTraitDef, RelTraitSet)")]
    ...
    /// <inheritdoc />
    [Provenance("org.apache.calcite.plan.volcano.AbstractConverter", "explainTerms(RelWriter)")]
    ...
    /// <inheritdoc />
    [Provenance("org.apache.calcite.plan.volcano.AbstractConverter", "computeSelfCost(RelOptPlanner, RelMetadataQuery)")]
    public override ICost ComputeSelfCost(IPlanner planner) => planner.CostFactory.MakeInfiniteCost();

    /// <inheritdoc />
    [Provenance("org.apache.calcite.plan.volcano.AbstractConverter", "isEnforcer()")]
    public bool IsEnforcer => true;

    /// <inheritdoc />
    [Provenance("org.apache.calcite.plan.volcano.AbstractConverter", "copy(RelTraitSet, List<RelNode>)")]
