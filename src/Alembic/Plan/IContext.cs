...
/// planner unwraps whatever it understands (e.g. a <see cref="Alembic.Util.CancelFlag"/>). Like Calcite's
/// <c>Context</c>, it adds nothing of its own — it is a typed bag, an <see cref="IWrapper"/>.
/// </summary>
