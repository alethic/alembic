...
/// </summary>
[Provenance("org.apache.calcite.plan.RelOptCostFactory")]
public interface ICostFactory
{
    ...
    /// </summary>
    [Provenance("org.apache.calcite.plan.RelOptCostFactory", "makeCost(double, double, double)")]
    ICost MakeCost(double cpu, double io);

    /// <summary>
    /// A cost of zero.
    /// </summary>
    [Provenance("org.apache.calcite.plan.RelOptCostFactory", "makeZeroCost()")]
    ICost MakeZeroCost();

    /// <summary>
    /// An infinite cost — an unimplementable or rejected plan.
    /// </summary>
    [Provenance("org.apache.calcite.plan.RelOptCostFactory", "makeInfiniteCost()")]
    ICost MakeInfiniteCost();

    /// <summary>
    /// An enormous but finite cost.
    /// </summary>
    [Provenance("org.apache.calcite.plan.RelOptCostFactory", "makeHugeCost()")]
    ICost MakeHugeCost();

    /// <summary>
    /// A small positive cost.
    /// </summary>
    [Provenance("org.apache.calcite.plan.RelOptCostFactory", "makeTinyCost()")]
    ICost MakeTinyCost();
