...
[Provenance("org.apache.calcite.util.graph.DirectedGraph")]
    ...
    where E : DefaultEdge
{
    ...
    /// </summary>
    [Provenance("org.apache.calcite.util.graph.DirectedGraph", "addVertex(V)")]
    ...
    /// </summary>
    [Provenance("org.apache.calcite.util.graph.DirectedGraph", "addEdge(V, V)")]
    E? AddEdge(V vertex, V targetVertex);

    /// <summary>
    /// The edge from <paramref name="source"/> to <paramref name="target"/>, or <c>null</c>.
    /// </summary>
    [Provenance("org.apache.calcite.util.graph.DirectedGraph", "getEdge(V, V)")]
    ...
    /// </summary>
    [Provenance("org.apache.calcite.util.graph.DirectedGraph", "removeEdge(V, V)")]
    bool RemoveEdge(V vertex, V targetVertex);

    /// <summary>
    /// The vertices, as a set (iterating in insertion order).
    /// </summary>
    [Provenance("org.apache.calcite.util.graph.DirectedGraph", "vertexSet()")]
    IReadOnlySet<V> VertexSet { get; }

    /// <summary>
    /// Removes every vertex in <paramref name="collection"/> and all edges into or out of them.
    /// </summary>
    [Provenance("org.apache.calcite.util.graph.DirectedGraph", "removeAllVertices(Collection<V>)")]
    void RemoveAllVertices(IEnumerable<V> collection);

    /// <summary>
    /// The edges leaving <paramref name="source"/>.
    /// </summary>
    [Provenance("org.apache.calcite.util.graph.DirectedGraph", "getOutwardEdges(V)")]
    IReadOnlyList<E> GetOutwardEdges(V source);

    /// <summary>
    /// The edges entering <paramref name="vertex"/>.
    /// </summary>
    [Provenance("org.apache.calcite.util.graph.DirectedGraph", "getInwardEdges(V)")]
    IReadOnlyList<E> GetInwardEdges(V vertex);

    /// <summary>
    /// All edges, as a set.
    /// </summary>
    [Provenance("org.apache.calcite.util.graph.DirectedGraph", "edgeSet()")]
    IReadOnlySet<E> EdgeSet { get; }

    /// <summary>
    /// Creates edges for a graph.
    /// </summary>
    [Provenance("org.apache.calcite.util.graph.DirectedGraph.EdgeFactory")]
    interface EdgeFactory
    {

        [Provenance("org.apache.calcite.util.graph.DirectedGraph.EdgeFactory", "createEdge(V, V)")]
