...
public interface INode
{
    ...
    /// </summary>
    [Provenance("org.apache.calcite.rel.RelNode", "getCluster()")]
    Cluster Cluster { get; }

    /// <summary>
    /// The physical properties (convention, etc.) carried by this node.
    /// </summary>
    [Provenance("org.apache.calcite.rel.RelNode", "getTraitSet()")]
    TraitSet Traits { get; }

    /// <summary>
    /// This node's child nodes, in order.
    /// </summary>
    [Provenance("org.apache.calcite.rel.RelNode", "getInputs()")]
    ImmutableArray<INode> Children { get; }

    /// <summary>
    /// Produces a copy of this node with the given traits and children.
    /// </summary>
    [Provenance("org.apache.calcite.rel.RelNode", "copy(RelTraitSet, List<RelNode>)")]
    ...
    /// </summary>
    [Provenance("org.apache.calcite.rel.RelNode", "deepEquals(Object)")]
    bool DeepEquals(INode? other);

    /// <summary>
    /// A hash consistent with <see cref="DeepEquals"/>.
    /// </summary>
    [Provenance("org.apache.calcite.rel.RelNode", "deepHashCode()")]
    int DeepHashCode();
    ...
    /// </summary>
    [Provenance("org.apache.calcite.rel.RelNode", "explain(RelWriter)")]
    void Explain(INodeWriter writer);

    /// <summary>
    /// This node's structural digest — the key the planner deduplicates on.
    /// </summary>
    [Provenance("org.apache.calcite.rel.RelNode", "getRelDigest()")]
    ...
    /// </summary>
    [Provenance("org.apache.calcite.rel.RelNode", "recomputeDigest()")]
    ...
    /// </summary>
    [Provenance("org.apache.calcite.rel.RelNode", "getConvention()")]
    ...
    /// </summary>
    [Provenance("org.apache.calcite.rel.RelNode", "isEnforcer()")]
    ...
    /// </summary>
    [Provenance("org.apache.calcite.rel.RelNode", "stripped()")]
    INode Stripped => this;
    ...
    /// </summary>
    [Provenance("org.apache.calcite.rel.RelNode", "computeSelfCost(RelOptPlanner, RelMetadataQuery)")]
